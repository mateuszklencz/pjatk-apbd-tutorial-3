...
public sealed class LinqExercises
{
    ...
    public IEnumerable<string> Task04_FirstAnalyticsCourse()
    {
        return UniversityData.Courses
            ...
            .Take(1) // Gets a collection containing only the first match
    ...
    {
        yield return UniversityData.Enrollments.Any(e => !e.IsActive) ? "True" : "False";
    }
    ...
    {
        yield return UniversityData.Lecturers.All(l => !string.IsNullOrEmpty(l.Department)) ? "True" : "False";
    }
    ...
    {
        yield return UniversityData.Enrollments.Count(e => e.IsActive).ToString();
    }
    ...
    public IEnumerable<string> Task09_ThreeNewestEnrollments()
    {
        return UniversityData.Enrollments
            ...
            .Take(3)
            .Select(e => $"{e.EnrollmentDate:yyyy-MM-dd} {e.StudentId} {e.CourseId}");
    }
